...
console.log(message)  // Uncaught SyntaxError
...
console.log(stack)    // Uncaught ReferenceError

function f3() {
  let queue = 'First In, First Out'
}
console.log(queue)    // Uncaught ReferenceError
...
console.log(lunch)
const lunch = '초밥'              // Uncaught ReferenceError

console.log(dinner)
let dinner = '스테이크'           // Uncaught ReferenceError